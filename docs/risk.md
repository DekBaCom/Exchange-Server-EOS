...
- Enable Windows Event Log forwarding to a SIEM ([Incident response](https://microsoft.com/security/incident-response))
...
- Define post-migration validation test for every critical application
